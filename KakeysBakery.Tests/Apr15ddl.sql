...
CREATE SEQUENCE "KakeysBakery".addon_id_seq
	...
	CACHE 1
	NO CYCLE;
-- DROP SEQUENCE "KakeysBakery".addonflavor_id_seq;

CREATE SEQUENCE "KakeysBakery".addonflavor_id_seq
	INCREMENT BY 1
	MINVALUE 1
	MAXVALUE 2147483647
	START 1
...
CREATE TABLE "KakeysBakery".addon (
	...
	CONSTRAINT addon_addonflavor_fk FOREIGN KEY (addonflavorid) REFERENCES "KakeysBakery".addonflavor(id),
	CONSTRAINT addon_addontype_fk FOREIGN KEY (addontypeid) REFERENCES "KakeysBakery".addontype(id)
);
...
CREATE TABLE "KakeysBakery".basegood (
	...
	CONSTRAINT basegood_goodsize_fkey FOREIGN KEY (sizeid) REFERENCES "KakeysBakery".basegood_size(id),
	CONSTRAINT basegoodname FOREIGN KEY (typeid) REFERENCES "KakeysBakery".basegoodtype(id),
